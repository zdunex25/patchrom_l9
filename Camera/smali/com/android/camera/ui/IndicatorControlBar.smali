...
.field private mZoomControl:Lcom/android/camera/ui/ZoomControlBar;
...
.method public enableZoom(Z)V
    ...
    .prologue
    .line 126
    iget-object v0, p0, Lcom/android/camera/ui/IndicatorControlBar;->mZoomControl:Lcom/android/camera/ui/ZoomControlBar;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/camera/ui/IndicatorControlBar;->mZoomControl:Lcom/android/camera/ui/ZoomControlBar;

    invoke-virtual {v0, p1}, Lcom/android/camera/ui/ZoomControlBar;->setEnabled(Z)V
...
.method public initialize(Landroid/content/Context;Lcom/android/camera/PreferenceGroup;Z)V
    ...
    .prologue
    .line 56
    invoke-virtual {p0, p2}, Lcom/android/camera/ui/IndicatorControlBar;->setPreferenceGroup(Lcom/android/camera/PreferenceGroup;)V

    .line 59
    invoke-virtual {p0}, Lcom/android/camera/ui/IndicatorControlBar;->initializeCameraPicker()V

    .line 60
    iget-object v0, p0, Lcom/android/camera/ui/IndicatorControlBar;->mCameraPicker:Lcom/android/camera/ui/CameraPicker;
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/ui/CameraPicker;->setBackgroundResource(I)V
    ...
    check-cast v0, Lcom/android/camera/ui/ZoomControlBar;

    iput-object v0, p0, Lcom/android/camera/ui/IndicatorControlBar;->mZoomControl:Lcom/android/camera/ui/ZoomControlBar;
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/ui/ZoomControlBar;->setVisibility(I)V

    .line 69
    :cond_1
    invoke-virtual {p0}, Lcom/android/camera/ui/IndicatorControlBar;->requestLayout()V
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 82
    iget-object v0, p0, Lcom/android/camera/ui/IndicatorControlBar;->mOnIndicatorEventListener:Lcom/android/camera/ui/OnIndicatorEventListener;
...
.method protected onLayout(ZIIII)V
    ...
    .line 104
    iget-object v5, p0, Lcom/android/camera/ui/IndicatorControlBar;->mZoomControl:Lcom/android/camera/ui/ZoomControlBar;
    ...
    invoke-virtual {v5, v6, v8, v7, v3}, Lcom/android/camera/ui/ZoomControlBar;->layout(IIII)V

    .line 108
    :cond_2
    iget-object v5, p0, Lcom/android/camera/ui/IndicatorControlBar;->mCameraPicker:Lcom/android/camera/ui/CameraPicker;
...
.method public setEnabled(Z)V
    ...
    .line 116
    iget v0, p0, Lcom/android/camera/ui/IndicatorControlBar;->mCurrentMode:I
